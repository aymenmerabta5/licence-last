            ...
            {items.map((txt, i) => (
              <span key={i} className="flex items-center gap-3">
                <Star
                  ...
                  aria-hidden="true"
                />
                <span className="text-xs font-semibold tracking-[0.2em] text-secondary-foreground dark:text-primary-foreground transition-colors duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] [[dir=rtl]_&]:tracking-normal">
                  {txt}
                </span>
              </span>
            ))}
